...
const allBooks = [
  { title: "Not In Love", author: "Ali Hazelwood", image: Book1, genre: "Romance", progress: 45 },
  { title: "Funny Story", author: "Emily Henry", image: Book2, genre: "Romance", progress: 60 },
  { title: "Fourth Wing", author: "Rebecca Yarrow", image: Book3, genre: "Fantasy", progress: 20 },
  { title: "Harry Potter", author: "J.K. Rowling", image: Book4, genre: "Adventure", progress: 75 },
  { title: "The Silent Patient", author: "Alex Michaelides", image: Book5, genre: "Thriller", progress: 35 },
  { title: "Verity", author: "Collen Hoover", image: Book6, genre: "Romance", progress: 10 },
  { title: "Atomic Habits", author: "James Clear", image: Book7, genre: "Self Help", progress: 90 },
  { title: "The Let Them Theory", author: "Mel Robbins", image: Book8, genre: "Motivation", progress: 55 },
  { title: "Just For The Summer", author: "Abbey Jimenez", image: Book9, genre: "Romance", progress: 65 },
  { title: "Hunger Games", author: "Suzanne Collins", image: Book10, genre: "Dystopian", progress: 40 },
  { title: "The Housemaid", author: "Freida McFadden", image: Book11, genre: "Thriller", progress: 25 },
  { title: "One Golden Summer", author: "Carley Fortune", image: Book12, genre: "Romance", progress: 80 },
];
...
const Recent: FC = () => {
  ...
  return (
    <Stack gap="10" style={styles.recentBody}>
      <Info />

      <Box style={styles.recentMain}>
        <Box style={styles.recentWrapper}>
